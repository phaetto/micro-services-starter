...
namespace Services.Cassini.Core
{
    ...
    class Request : SimpleWorkerRequest {
        ...
        static string[] defaultFileNames = new string[] {
            "default.aspx", "default.htm", "default.html", "default.ashx",
            "Default.aspx", "Default.htm", "Default.html", "Default.ashx" };
        ...
        bool TryParseRequest() {
            ...
            // Probably put the dialog here.
            // Also manage allowances through a simple variable
            // Drop connection forcefully?
            // _connection.Close(); // Use events?
        ...
        public override string GetServerVariable(string name) {
            ...
            switch (name) {
                ...
                case "SERVER_SOFTWARE":
                    s = "Customized-Cassini/" + Messages.VersionString;
                    break;
            }
        ...
        public override string MapPath(string path) {
            ...
            if (mappedPath.EndsWith(Path.DirectorySeparatorChar.ToString(), StringComparison.Ordinal) && !mappedPath.EndsWith(":\\", StringComparison.Ordinal)) {
